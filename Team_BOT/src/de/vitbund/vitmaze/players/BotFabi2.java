	...
	public static void main(String[] args) {
		...
		while (input.hasNext()) {
			...
			if (lastActionsResult.equals("OK")) {
				...
				map.merkeLetztesFeld(currentCellStatus, lastActionsResult, a, b, y, x, playerId);
				
				map.sucheWeg(currentCellStatus, lastActionsResult, a, b, y, x, playerId);
				a++;
				b++;
			}
